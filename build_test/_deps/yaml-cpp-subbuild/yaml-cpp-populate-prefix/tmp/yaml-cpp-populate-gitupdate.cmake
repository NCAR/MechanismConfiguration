...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "28f93bdec6387d42332220afa9558060c8016795"
  WORKING_DIRECTORY "/home/runner/work/MechanismConfiguration/MechanismConfiguration/build_test/_deps/yaml-cpp-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/runner/work/MechanismConfiguration/MechanismConfiguration/build_test/_deps/yaml-cpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/runner/work/MechanismConfiguration/MechanismConfiguration/build_test/_deps/yaml-cpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
