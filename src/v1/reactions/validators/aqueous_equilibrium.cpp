...
namespace mechanism_configuration
{
  namespace v1
  {
    /// @brief Validates a YAML-defined Aqueous Equilibrium reaction entry.
    ...
    Errors AqueousEquilibriumParser::Validate(
        ...
        const std::vector<types::Phase>& existing_phases)
    {
      ...
      std::vector<std::string_view> optional_keys = { validation::name, validation::A, validation::C };
