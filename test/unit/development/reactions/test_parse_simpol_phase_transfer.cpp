...
TEST(ValidateSimpolPhaseTransfer, TooManyGasSpeciesFailsValidation)
{
  ...
  std::vector<types::Phase> existing_phases = {
    types::Phase{ .name = "gas", .species = { types::PhaseSpecies{ .name = "A" }, types::PhaseSpecies{ .name = "C" } } },
    types::Phase{ .name = "aqueous", .species = { types::PhaseSpecies{ .name = "B" } } }
  };
...
TEST(ValidateSimpolPhaseTransfer, TooManyCondensedSpeciesFailsValidation)
{
  ...
  std::vector<types::Phase> existing_phases = {
    types::Phase{ .name = "gas", .species = { types::PhaseSpecies{ .name = "A" } } },
    types::Phase{ .name = "aqueous", .species = { types::PhaseSpecies{ .name = "B" }, types::PhaseSpecies{ .name = "C" } } }
  };
